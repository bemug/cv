...
\title{Ingénieur informatique}                               % optional, remove / comment the line if not wanted
...
\cvitem{Programmation}{Développement de jeux vidéo amateurs et d'applications
	open source}
\cvitem{Loisirs}{Jeux vidéo}
